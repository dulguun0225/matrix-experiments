import { Appservice, IAppserviceOptions, IAppserviceRegistration, MemoryStorageProvider, SimpleRetryJoinStrategy } from 'matrix-bot-sdk';
import { AutojoinRoomsMixin } from 'matrix-bot-sdk/lib/mixins/AutojoinRoomsMixin';
